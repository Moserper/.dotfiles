# Generated by Powerlevel10k configuration wizard on 2021-04-13 at 13:54 +07.
...
() {
  ...
  # Custom icon.
  # typeset -g POWERLEVEL9K_RAM_VISUAL_IDENTI:IER_EXPANSION='⭐'
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=228
