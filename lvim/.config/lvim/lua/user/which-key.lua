...
wk.mappings["S"] = {
  name = " pepersistence.nvimrsistence.nvim",
...
-- wk.mappings[']'] = { ":bnext<cr>", "Next Tab" }
-- wk.mappings['['] = { ":bprev<cr>", "Prev Tab" }
wk.mappings['E'] = { "<cmd>NvimTreeFocus<CR>", "Explorer" }

-- wk.mappings["l"]["t"] = { ":LvimToggleFormatOnSave<cr>", kind.symbols_outline.File .. " Toggle format-on-save" }
-- wk.mappings["t"]["p"] = { ':Telescope find_files<cr>', 'Find Files' }
-- wk.mappings["t"] = {
--   p = { ':Telescope find_files<cr>', '{}' }, -- requires Projectstelescope-project.nvim plugin
--   name = ' Telescope',
...
wk.mappings["p"] = nil
wk.mappings["c"] = nil
wk.mappings["bc"] = { "<cmd>BufferKill<CR>", "Close Buffer" }
wk.mappings["P"] = {
  name = "Plugins",
